...
public class DefaultJeepOrderService implements JeepOrderService {
  ...
  protected void getTire(OrderRequest orderRequest) throws X {
  ...
  protected void getEngine(OrderRequest orderRequest) throws X {
   ...
   * @throws X
   */
  protected void getColor(OrderRequest orderRequest) throws X {
  ...
  protected void getModel(OrderRequest orderRequest) throws X {
    jeepOrderDao
  ...
  protected void getCustomer(OrderRequest orderRequest) throws X {
